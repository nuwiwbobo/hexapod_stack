// =============================================================================
// test_ik_stance.cpp — Standalone: move one leg to standing position via IK
// =============================================================================
// Build: colcon build --packages-select hexapod_ik
// Run:   ros2 run hexapod_ik test_ik_stance_exec
//
